...
background-image: url("https://5.imimg.com/data5/SELLER/Default/2023/2/BQ/UZ/PS/23060011/unique-betrol-bunk-software-500x500.jpg");
background-size: 100%;
...
def main():
    ...
    st.markdown("<h1 style='text-align: center; color: #03C988;'>Fuel Consumption Prediction</h1>", unsafe_allow_html=True)        
